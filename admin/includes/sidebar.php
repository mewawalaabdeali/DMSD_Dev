   <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <p style="color: white">Turtle Zoo ADMIN</p>
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-folder"></i><span>Employee Details</span></a>
                                <ul class="collapse">
                          ...
                          <li>
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="animalpopulation.php">Animal population<br/>Total FoodCost<br/>Total Salary<br/></a></li>
                                </ul>
                            </li>
